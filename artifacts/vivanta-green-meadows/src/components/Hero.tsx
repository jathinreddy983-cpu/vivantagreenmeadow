          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-left">
              ...
              >
                ...
                <button
                  className="inline-flex items-center justify-center gap-2.5 px-8 py-3.5 squircle-lg border border-forest-800/20 hover:border-forest-800/80 bg-white/60 hover:bg-white/95 text-forest-900 font-sans text-xs uppercase tracking-[0.2em] font-bold transition-all duration-300 shadow-sm hover:shadow-md cursor-default"
                >
